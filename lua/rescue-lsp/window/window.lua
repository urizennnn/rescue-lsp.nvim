...
function win.insert_into_buf(buf,prev_buf_id,setup)
    ...
    pcall(function() vim.api.nvim_buf_add_highlight(buf, -1, client_count > 0 and "GreenText" or "RedText", client_count_index, 0, -1) end)
    pcall(function() vim.api.nvim_buf_add_highlight(buf, -1, "LightBlueText", #lines - 1, 0, -1) end)
end
